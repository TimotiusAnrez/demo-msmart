...
export function ProfileEditForm({ user, onSave, onCancel }: ProfileEditFormProps) {
  const form = useForm<ProfileFormData>({
    ...
    defaultValues: {
      ...
      email: user.contact.email.handler,
  ...
  const onSubmit = (data: ProfileFormData) => {
    onSave({
      ...
      contact: {
        email: {
          handler: data.email,
          isVerified: user.contact.email.isVerified,
        },
        phone: {
          number: data.phone || null,
          isVerified: user.contact.phone?.isVerified || false,
        },
      },
      verification: {
        ...
        rejectReason: user.verification.rejectReason,
      },
    })
  }
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        type="date"
                        {...field}
                        value={new Date(user.information.DOB).toISOString().split('T')[0]}
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select onValueChange={field.onChange} defaultValue={field.value || 'IDCARD'}>
                      <FormControl>
                        <SelectTrigger>
